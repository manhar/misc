# Majority of the code is copied from https://www.kaggle.com/tunguz/lgbm-ridge-0-45529-lb
...
X_descp = svd.fit_transform(count_descp.fit_transform(df["item_description"]))
...
print ("completing Ridge Regression fit")
preds += model.predict(X_test)
preds /= 2

print("test_df count" + str(len(df_test)))
df_test["price"] = np.expm1(preds).round(3)
df_test["test_id"] = df_test.index
